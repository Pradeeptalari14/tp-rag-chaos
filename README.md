...
> Kubernetes chaos experiments injecting network delays inside vector database instances.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-chaos/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-chaos.git
cd tp-rag-chaos
```
...
```bash
kubectl port-forward deployment/tp-rag-chaos 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── chaos_experiment.yaml     # Main configuration file
```
...
---
*Generated by [RAG-Chaos Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-chaos/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
